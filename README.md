...
#### 2. Гибкий поиск (≈)
Если точное совпадение не найдено, выполняется гибкий поиск:
- Удаляются знаки препинания, специальные символы и цифры
- Множественные пробелы заменяются на один
- Ищется совпадение очищенного текста
- Если полное совпадение не найдено, ищется совпадение по ключевым словам (минимум 2 общих слова)
